...
const OrderInfoModal = (props: PropTypes) => {
  ...
  return (
    <Modal open={props.isOpened} keepMounted={false}>
      <div className="modal">
        ...
        <Typography variant="h5" className="title">Деталі замовлення</Typography>
        { props.order && <div className="modal-info">
          <Grid container columns={3}>
            ...
            <Grid item xs={2}>
              <Typography variant="body1">{ props.order.lastName } { props.order.firstName } { props.order.middleName }</Typography>
            </Grid>
            ...
            <Grid item xs={2}>
              <Typography variant="body1">{ props.order.deliveryToServiceCenter ? "Так" : "Ні" }</Typography>
            </Grid>
            ...
            <Grid item xs={2}>
              <Typography variant="body1">{ props.order.deliveryFromServiceCenter ? "Так" : "Ні" }</Typography>
            </Grid>
            ...
            <Grid item xs={2}>
              <Typography variant="body1">{ props.order.address }</Typography>
            </Grid>
